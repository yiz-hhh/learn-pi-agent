/**
 * Chapter 09 的最小扩展点：让能力以数据进入 Harness。
 *
 ...
 * 与 Pi 对齐：additionalInstructions 用真值判定（传 "" 不追加，skills.ts L40）；
 * 剪裁：Pi 块内含 references 引导行（L39 References are relative to...），教学不解析相对引用。 */
